...
<body>
  ...
  <div class="container my-4">
    <h2 class="text-orange mb-4" style="margin-top: 10%; color:#7c5092;">Artikel kelinci</h2>
    <div class="row">
      <div class="col-md-3">
        <div class="card">
          <img src="https://images.tokopedia.net/blog-tokopedia-com/uploads/2019/10/makanan-kelinci-12-Pixabay.jpg" class="card-img-top" alt="Artikel 1">
          <div class="card-body">
           <a href="" style="text-decoration: underline; color:#6d4c7d;"><h5 class="card-title" >Tips Memilih Makanan Kelinci Sesuai Kebutuhan</h5></a>
      ...
      <div class="col-md-3">
        <div class="card">
          <img src="https://www.dictio.id/uploads/db3342/original/3X/7/b/7b78469a648476d94d4f0b5b8b30daff659adce2.jpeg" class="card-img-top" alt="Artikel 2">
          <div class="card-body">
           <a href="" style="text-decoration: underline; color:#6d4c7d;"><h5 class="card-title">Tips Agar Kelincimu Tidak Berontak Saat Potong Kuku. Ajaklah Bermain!</h5></a> 
            <p class="card-text">Siapa nih yang kewalahan potong kuku kelinci kesayangan?</p>
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="card">
          <img src="https://bakpaorabbit.com/storage/2021/07/kelinci-berlari.jpg" class="card-img-top" alt="Artikel 3">
          <div class="card-body">
           <a href="" style="text-decoration: underline; color:#6d4c7d;"><h5 class="card-title">Kenali Bahasa Tubuh Kelinci: Apa Arti Gerakan Ekor dan Kupingnya?</h5></a> 
            <p class="card-text">Kelinci berkomunikasi dengan bahasa tubuh. Yuk kenali bahasa tubuhnya!</p>
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="card">
          <img src="https://o-cdn-cas.oramiland.com/parenting/images/Kelinci_Makan_Rumput.width-800.format-webp.webp" class="card-img-top" alt="Artikel 4">
          <div class="card-body">
           <a href="" style="text-decoration: underline; color:#6d4c7d;"><h5 class="card-title">Cara Membuat Kelincimu Lebih Aktif: Permainan yang Dapat Mengusir Kebosanan</h5></a>
