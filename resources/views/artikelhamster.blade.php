...
<body>
  ...
  <div class="container my-4">
    <h2 class="text-orange mb-4" style="margin-top: 10%; color:#7c5092;">Artikel Hamster</h2>
    <div class="row">
      <div class="col-md-3">
        <div class="card">
          <img src="https://s3-publishing-cmn-svc-prd.s3.ap-southeast-1.amazonaws.com/article/NWooEG6PwM4EWITVHHVND/original/1672978504-Pelet%20Hamster.jpg" class="card-img-top" alt="Artikel 1">
          <div class="card-body">
           <a href="" style="text-decoration: underline; color:#6d4c7d;"><h5 class="card-title" >Tips Memilih Makanan Hamster Sesuai Kebutuhan</h5></a>
            <p class="card-text">Untuk memberi makanan, sebaiknya sesuaikan kandungan pada makanan dengan kebutuhan hamster kita, ya!</p>
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="card">
          <img src="https://asset.kompas.com/crops/nwqDt7KOA7iVy02iWwmiZoKJ8ug=/0x0:720x480/750x500/data/photo/2022/08/02/62e8a4d9f098b.jpg" class="card-img-top" alt="Artikel 2">
          <div class="card-body">
           <a href="" style="text-decoration: underline; color:#6d4c7d;"><h5 class="card-title">Cara Aman Memandikan Hamster Peliharaan</h5></a> 
            <p class="card-text">Siapa nih yang kewalahan mandiin hamster kesayangan?</p>
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="card">
          <img src="https://cdn1.katadata.co.id/media/images/thumb/2022/11/09/Ilustrasi_cara_menjinakkan_hamster-2022_11_09-05_54_34_4d9c95b68877eafd453d2a491635ca49_960x640_thumb.jpg" class="card-img-top" alt="Artikel 3">
          <div class="card-body">
           <a href="" style="text-decoration: underline; color:#6d4c7d;"><h5 class="card-title">Kenali Bahasa Tubuh Hamster</h5></a> 
            <p class="card-text">Hamster berkomunikasi dengan bahasa tubuh. Yuk kenali bahasa tubuhnya!</p>
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="card">
          <img src="https://img-cdn.medkomtek.com/7dIpzIXH2w-HPEvPfgPL0J7GMos=/690x387/smart/filters:quality(100):format(webp)/article/Bqbe_b8eUpk-JURCaTWEp/original/1672486933-Sediakan%20Kandang%20yang%20Luas.jpg" class="card-img-top" alt="Artikel 4"> 
          <div class="card-body">
            <a href="" style="text-decoration: underline; color:#6d4c7d;"><h5 class="card-title">Cara Membuat Hamstermu Lebih Aktif: Permainan yang Dapat Mengusir Kebosanan</h5></a>
  ...
  <div class="container my-4" style="margin-left: 5%">
    <div class="row">
      <div class="col-md-3">
        <div class="card">
          <img src="https://s3-publishing-cmn-svc-prd.s3.ap-southeast-1.amazonaws.com/article/NWooEG6PwM4EWITVHHVND/original/1672978504-Pelet%20Hamster.jpg" class="card-img-top" alt="Artikel 1">
